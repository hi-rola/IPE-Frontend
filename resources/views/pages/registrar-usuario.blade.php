                            ...
                            <div class="col-lg-12 col-xxl-12">
                                <div class="card card-custom card-stretch gutter-b">
                                    <div class="card-header border-0">
                                        <h3 class="card-title font-weight-bolder text-dark">Registrar usuario</h3>
                                    </div>
                                    <!--begin::Body-->
                                    <form class="form">
                                        <div class="card-body">
                                                ...
                                                <div class="col-lg-6 mt-5">
                                                    ...
                                                    <div class="input-group">
                                                        <select class="form-control form-control">
                                                            <option selected>Seleeciona un tipo de rol</option>
                                        ...
                                        <div class="card-footer col-sm-12">
                                            <div class="row">
                                                <div class="col-sm-12 col-lg-6 d-flex justify-content-center py-2">
                                                    <button type="reset" class="btn btn-primary col-sm-12 col-lg-4">Registrar</button>
                                                </div>
                                                <div class="col-sm-12 col-lg-6 d-flex justify-content-center py-2">
